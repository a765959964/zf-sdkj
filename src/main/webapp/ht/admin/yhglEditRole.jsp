	...
	<form id="admin_yhglEditRole_editForm" method="post">
		...
		<table class="tableForm">
			<tr>
				<th>所属角色</th>
				<td>
					<input id="admin_yhglEditRole_combogrid" name="roleIds" style="width: 155px;" />
				</td>
				<td>
					<span class="icon-cut icon-block" onclick="$('#admin_yhglEditRole_combogrid').combogrid('clear');"></span>
				</td>
			</tr>
		</table>
	</form>
