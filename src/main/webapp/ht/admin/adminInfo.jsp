...
<script type="text/javascript" charset="utf-8">
	$(function() {
		$('#admin_adminInfo_tree').tree({
			url : '${pageContext.request.contextPath}/do/resource/allTreeNode',
			parentField : 'pid',
			lines : true,
			checkbox : true,
...
<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'center',title:'个人信息',border:false" style="overflow: hidden;padding: 5px;" align="center">
