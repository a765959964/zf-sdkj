	...
	<form id="articleEditForm" method="post">
		<table class="tableForm">
			<tr style="display: none">
				<th>编号</th>
				<td>
					<input name="articleId" value="${article.articleId }"
						readonly="readonly" style="width: 370px;" />
				</td>
			</tr>
			<tr>
				<th>标题</th>
				<td>
					<input name="title" value="${article.title }"
						class="easyui-validatebox" style="width: 370px;" />
				</td>
			</tr>
			...
			<tr>
				<th>副标题</th>
				<td>
					<input name="tip" value="${article.title }"
						class="easyui-validatebox" style="width: 370px;" />
				</td>
			</tr>
			...
			<tr>
				<th>所属栏目</th>
				<td colspan="3">
					<input name="cid" value="${article.cid }" class="easyui-combotree"
			...
			<tr>
				<th>缩略图</th>
				<td>
					<img alt="" src="${article.pic}" id="article_picshow" width="100px" />
					<input name="pic" id="pic" class="easyui-validatebox"
						style="display: none" value="${article.pic}" />
					<br />
			...
			<tr>
				...
				<td>
					<input name="sort" style="width: 370px;"
						...
						value="${article.sort}" style="width: 155px;" />
				</td>
			</tr>
			<tr>
				<th>大图</th>
				<td>
					<img alt="" src="${article.bigpic}" id="article_bigpicshow"
						width="100px" />
					<input name="bigpic" id="bigpic" class="easyui-validatebox"
						style="display: none" value="${article.bigpic}" />
					<br />
			...
			<tr>
				<td colspan="2">
					<textarea name="content" style="width: 500px">${article.content}</textarea>
				</td>
			</tr>
