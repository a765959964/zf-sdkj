...
<div align="center">
	<form id="column_edit_form" method="post">
		<table class="tableForm">
			...
			<tr>
				<th>自定义排序</th>
				<td>
					<input name="sort" style="width: 370px;" class="easyui-numberspinner" data-options="min:0,max:999,editable:false,required:true,missingMessage:'请选择排序'" value="${article.sort}" style="width: 155px;" />
				</td>
			</tr>
		</table>
	</form>
